...
const CreatePost: React.FC = () => {
  ...
  return (
    <Card className="mb-4 bg-card-post cursor-pointer border-0 hover:shadow-xl transition-shadow duration-200">
          ...
          <div className="flex-1">
            <form onSubmit={handleSubmit}>
              <textarea
                ...
                className="w-full min-h-20 p-2 text-sm bg-transparent border-none outline-none resize-none placeholder:text-muted-foreground"
                rows={3}
              />
              {image && (
